...
<div class="container">
    <div class="static-page">
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-5">
                    <h2><?= Yii::t('app', 'New Customer') ?></h2>
                    <p><strong><?= Yii::t('app', 'Register Account') ?></strong></p>
                    <p><?= Yii::t('app', 'By creating an account you will be able to shop faster, be up to date on an order\'s status, and keep track of the orders you have previously made.') ?></p>
                    <a href="<?= Html::encode(Url::to(['/site/signup'])) ?>" class="btn btn-success"><?= Yii::t('app', 'Continue') ?></a>
                </div>
            </div>
            <div class="col-sm-6">
                <h2><?= Yii::t('app', 'I have an account') ?></h2>
