...
<div id="header-nav">
    <div class="content-mainMenu mainMenu">
        <div class="mainMenu-item dropdown">
            <div class="leftMenu-block-title">Каталог запчастей&nbsp;<i class="fa fa-arrow-down"></i></div>
            <div class="dropdown-content" id="dropdown-content">
                ...
                <div class="leftMenu-block-title"><div style="width: 100%; padding-right: 5px;"><a href="/test/manufacturers">Запчасти по производителям</a></div></div>
                <div class="leftMenu-block-title"><div style="width: 100%; padding-right: 5px;"><a href="/test/groups">Запчасти по группам</a></div></div>
            </div>
        </div>
    ...
    <div class="search search_mainMenu">
        <form action="/search/" method="get">
            ...
            <?= Html::a('Найти', ['#'], ['class' => 'btn btn-warning', 'title' => 'Найти']) ?>
        </form>
    </div>
</div>
        ...
        <div class="slider-feedback">
            <div class="imageSlider">
                <div class="imageSlider-content">
                    <div class="imageSlider-content-item imageSlider-content-item_active" style="background-image: url('/images/1.png');"><?= Html::a('Подробнее', ['#'], ['class' => 'btn btn-warning btn-lg', 'title' => 'Подробнее']) ?></div>
                    <div class="imageSlider-content-item" style="background-image: url('/images/2.png');"><?= Html::a('Подробнее', ['#'], ['class' => 'btn btn-warning btn-lg', 'title' => 'Подробнее']) ?></div>
                    <div class="imageSlider-content-item" style="background-image: url('/images/3.png');"><?= Html::a('Подробнее', ['#'], ['class' => 'btn btn-warning btn-lg', 'title' => 'Подробнее']) ?></div>
                    <div class="imageSlider-content-item" style="background-image: url('/images/4.png');"><?= Html::a('Подробнее', ['#'], ['class' => 'btn btn-warning btn-lg', 'title' => 'Подробнее']) ?></div>
                    <div class="imageSlider-content-item" style="background-image: url('/images/5.png');"><?= Html::a('Подробнее', ['#'], ['class' => 'btn btn-warning btn-lg', 'title' => 'Подробнее']) ?></div>
                </div>
